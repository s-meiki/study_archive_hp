...
import { LegalDetailGrid, LegalPage, LegalReferenceLinks, LegalSection } from "../components/legal-page";
...
const linkGroups = [
  {
    ...
    links: [
      ...
      { href: "/archives", label: "勉強会アーカイブ一覧" }
    ]
  }
];
  ...
  return (
    <LegalPage
      ...
      stats={[
        ...
        { label: "窓口", value: siteLegal.contactOffice },
        { label: "最終更新", value: <span className="tabular-nums">{siteLegal.updatedDate}</span> }
      ]}
    ...
    >
      <LegalSection
        id="privacy-basic-policy"
        index="01"
        lead="個人情報は必要最小限で扱い、教育アーカイブとしての安全性を優先します。"
        title="基本方針"
      >
      ...
      <LegalSection
        ...
        index="02"
        lead="自動取得される技術情報と、運営や問い合わせに必要な情報を対象とします。"
        title="扱う情報"
      >
        <ul>
      ...
      <LegalSection
        id="privacy-purposes"
        index="03"
        lead="学習アーカイブの継続運営、問い合わせ対応、権利処理、安全対策のために利用します。"
        title="利用目的"
      >
        <ul>
      ...
      <LegalSection
        ...
        index="04"
        lead="機能提供や不正利用対策のため、必要な範囲で外部事業者のサービスを利用します。"
        title="外部サービスと外部送信"
      >
        <ul>
        ...
        <LegalReferenceLinks
          label="参照先"
          links={[
            { href: "https://policies.google.com/privacy", label: "Google" },
            { href: "https://jp.youtube.com/t/terms", label: "YouTube" },
            { href: "https://developers.cloudflare.com/turnstile/", label: "Cloudflare Turnstile" },
            { href: "https://discord.com/privacy", label: "Discord" },
            { href: "https://vercel.com/legal/privacy-policy", label: "Vercel" }
          ]}
        />
      </LegalSection>
      ...
      <LegalSection
        id="privacy-sharing"
        index="05"
        lead="法令上認められる場合を除き、本人の同意なく第三者提供は行いません。"
        title="第三者提供と委託"
      >
      ...
      <LegalSection
        id="privacy-security"
        index="06"
        lead="公開運用に必要な確認とアクセス制御を行い、事故発生時は速やかに対応します。"
        title="安全管理"
      >
        <ul>
      ...
      <LegalSection
        id="privacy-rights"
        index="07"
        lead="法令に基づく請求や削除依頼には、窓口を通じて適切に対応します。"
        title="開示・訂正・削除等"
      >
      ...
      <LegalSection
        id="privacy-operator"
        index="08"
        lead="運営主体と問い合わせ導線を、確認しやすい形で明示しています。"
        title="運営者情報"
      >
        <LegalDetailGrid
          items={[
            { label: "サイト名", value: siteLegal.siteName },
            { label: "運営者名", value: siteLegal.operatorName },
            { label: "窓口", value: siteLegal.contactOffice },
            { label: "所在地", value: siteLegal.location },
            { label: "連絡方法", value: <a href={siteLegal.contactUrl}>問い合わせフォーム</a> },
            {
              label: "関連ページ",
              value: (
                <>
                  <a href="/archives">勉強会アーカイブ一覧</a> / <a href={siteLegal.termsUrl}>利用規約</a>
                </>
              )
            }
          ]}
